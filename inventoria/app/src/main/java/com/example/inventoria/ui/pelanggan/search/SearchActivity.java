...
import com.example.inventoria.ui.pelanggan.PelangganAdapter;
...
public class SearchActivity extends AppCompatActivity implements SearchView {
    ...
    public void statusSuccess(UserResponse userResponse) {
        adapter = new PelangganAdapter(userResponse.getData(), SearchActivity.this);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerItemClickListener(SearchActivity.this,
                new RecyclerItemClickListener.OnItemClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        ...
                        Intent intent = new Intent(SearchActivity.this, PelangganActivity.class);
