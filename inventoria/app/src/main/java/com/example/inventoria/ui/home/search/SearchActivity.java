...
import com.example.inventoria.ui.home.HomeAdapter;
...
public class SearchActivity extends AppCompatActivity implements SearchView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new GridLayoutManager(SearchActivity.this,2, RecyclerView.VERTICAL,false));
    ...
    public void statusSuccess(BarangResponse barangResponse) {
        adapter = new HomeAdapter(barangResponse.getData(), SearchActivity.this);
