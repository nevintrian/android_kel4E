...
public class ProfilAdapter extends RecyclerView.Adapter<ProfilAdapter.ViewHolder> {
    ...
    public ProfilAdapter(List<User> users, Context context) {
        mContext = context;
        this.users = users;
    }
    ...
    public User getProfil(int position) {
        return users.get(position);
    }

    public class ViewHolder extends RecyclerView.ViewHolder {

        TextView email, username, password, level, nama, tgl_lahir, jenis_kelamin, alamat, no_telp;
        ImageView foto;
